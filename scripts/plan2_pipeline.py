...
def main():
    ...
    ap.add_argument("--mentor", default="data/raw/testing/mentor_master_experiments.xlsx")
    ap.add_argument("--pdf", default="data/raw/testing/external_coil_tube_chf_appendix.pdf")
